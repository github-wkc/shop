...
function checkForm(){
	...
	if(password2 == null || password2 ==""){
		...
		sp3.innerHTML = "<font color='red'>密码不能为空</font>";
		flag = false;
	}
	...
	if(email == null || email ==""){
		...
		sp4.innerHTML = "<font color='red'>email不能为空</font>";
		flag = false;
	}
	return flag;
};
...
window.onload = function(){
	var ban = document.getElementsByTagName("input");
	for(var b=0 ;b< ban.length - 1;b++){
		ban[b].value="";
	}
};   --%>
function checkUsername(){
	...
	// 3  打开链接
	xmlHttp.open("GET","${pageContext.request.contextPath}/user_findByName.action?date=" + new Date().getTime() +  "&username=" + username,true);
	// 4 发送
	xmlHttp.send(null);
}
...
function onImg(){
	...
	IMG.src="${pageContext.request.contextPath}/user_vertify.action?ff=" + new Date().getTime();
}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"  accept="false" method="post" action="${pageContext.request.contextPath }/user_register.action" >
						...
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" value="" autocomplete="off"  id="username" name="username" onblur="checkUsername();"  class="text" maxlength="20"/>
									  <span id="sp1" ><font color="red"><s:property value="fieldErrors.username[0]"/></font></span>
								</td>
							</tr>  
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password"  value=""name="password" class="text" maxlength="20" autocomplete="off"/>
									 <span id="sp2"><font color="red"><s:property value="fieldErrors.password[0]"/></font></span>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="password" id="password1"  value="" name="repassword" class="text" maxlength="20" autocomplete="off"/>
									 <span id="sp3"><font color="red"><s:property value="fieldErrors.repassword[0]"/></font></span>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text" id="email" name="email" class="text" maxlength="200"/>
									 <span id="sp4"><font color="red"><s:property value="fieldErrors.email[0]"/><font></font></span>
								</td>
							</tr>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
												<input id="phone" type="text" class="text" name="phone"/>
												 <span id="sp6"></span>
										</td>
									</tr>
								...
								<tr>
									<th>
										<span class="vertify">*</span>验证码:
									</th>
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" /><img id="checkImg" class="captchaImage" onclick="onImg();" src="${pageContext.request.contextPath}/user_vertify.action" title="点击更换验证码"/>
											 <span id="sp8"></span>
										</span>
									</td>
								</tr>
							<tr>
								...
								<td>
									<input type="submit" readonly="true" class="submit" value="同意以下协议并注册" />
								</td>
							</tr>
							<tr>
								<th>&nbsp;
