...
<div class="container cart">
		...
		<div class="span24">
			...
			<form id="orderForm" action="./order_payOrder.action" method="post">
				...
				<div class="span24">
					<p>
							收货地址：<input name="order.user.addr" type="text" value="<s:property value="#session.reuser.addr"/>" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="order.user.username" type="text" value="<s:property value="#session.reuser.name"/>" style="width:150px" />
								<br /> 
							联系方式：<input name="order.user.phone" type="text" value="<s:property value="#session.reuser.phone"/>" style="width:150px" />
