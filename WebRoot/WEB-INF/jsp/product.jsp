	...
	<%@include file="menu.jsp" %>
		...
		<div class="span6">
			<div class="hotProductCategory">
				<s:iterator value="#session.clist" var="cl">
						<dl>
							<dt>
								<a href="${pageContext.request.contextPath }/product_findByCid.action?cid=<s:property value="#cl.cid"/>&currentPage=1"><s:property value="#cl.cname"/></a>
							</dt>
								<s:iterator value="#cl.categoryseconds" var="cs">
									<dd>
		...
		<div class="span18 last">
			...
			<form action="${pageContext.request.contextPath }/cart_addCartItem.action" method="post" id="cart1">
				<input  name="pid" type="hidden" value="<s:property value="model.pid"/>"/>
					<div class="action">
							...
							<dl class="quantity">
								<dt>购买数量:</dt>
								<dd>
									<input id="quantity" name="number" value="1" maxlength="4" onpaste="return false;" type="text"/>
									<div>
						...
						<div class="buy">
								<input id="addCart" class="addCart" onclick="saveCart();" value="加入购物车" type="button"/>
						</div>
					</div>
			</form>
