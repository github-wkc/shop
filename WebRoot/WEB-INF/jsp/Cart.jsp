	...
	<%@ include file="menu.jsp" %>
		...
		<div class="span24">
			<div class="step step1">
				...
				<s:if test="#session.cart.cartItems.size() != 0"><%-- 判断items的为空     .size() ==0  如果是get/set方法 可以直接写.size --%>
				<table>
					<tbody>
					<tr>
						<th>图片</th>
					...
					<s:iterator value="cart.cartItems" var="item">
						<tr>
							<td width="60">
							...
							<td>
								<a href="${pageContext.request.contextPath }/cart_removeItem.action?pid=<s:property value="#item.product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
					</s:iterator>
				</tbody>
